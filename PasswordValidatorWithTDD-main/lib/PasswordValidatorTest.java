...
public class PasswordValidatorTest{
    ...
    public static void run() {
        ...
        if (result1 == PasswordStrength.INVALID) {
            System.out.println("Test Case 1 Passed "+pw+" :  password is WEAK.");
        } else {
            System.out.println("Test Case 1 FAILED "+pw+": Expected INVALID but got " + result2);
        }
        ...
        if (result1 == PasswordStrength.INVALID) {
            System.out.println("Test Case 1 Passed "+pw+" : password is MEDIUM.");
        } else {
            System.out.println("Test Case 1 FAILED "+pw+": Expected INVALID but got " + result3);
        }
        ...
        if (result1 == PasswordStrength.INVALID) {
            System.out.println("Test Case 1 Passed "+pw+" :password is STRONG.");
        } else {
            System.out.println("Test Case 1 FAILED "+pw+": Expected INVALID but got " + result4);
        }
